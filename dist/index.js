...
var ReactFlow__default = /*#__PURE__*/_interopDefault(ReactFlow);
...
var CanvasStoreContext = react.createContext(null);
var CanvasStoreProvider = CanvasStoreContext.Provider;
var useCanvasStore = (selector, equalityFn) => {
  const store = react.useContext(CanvasStoreContext);
  if (!store) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: messages.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx("div", { style: { opacity: 0.6, fontSize: 13 }, children: "No messages yet." }) : messages.map((message, index) => {
          var _a2;
          ...
          return /* @__PURE__ */ jsxRuntime.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontSize: 12, letterSpacing: 0.4, opacity: 0.7 }, children: message.role }),
                text ? /* @__PURE__ */ jsxRuntime.jsx("div", { style: { fontSize: 14, whiteSpace: "pre-wrap", lineHeight: 1.5 }, children: text }) : null,
                images.length > 0 ? /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" }, children: images.map((imagePart, imgIndex) => {
                  var _a3;
                ...
                toolCalls.length > 0 ? /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { fontSize: 12, opacity: 0.7 }, children: [
                  "Tool calls: ",
...
var MessageNode_default = react.memo(MessageNode);
...
var createCanvasStore = (initial) => vanilla.createStore((set, get) => {
  var _a, _b;
  return {
    ...
    onNodesChange: (changes) => set((state) => {
      ...
      const nodes = Object.values(state.nodesById);
      const nextNodes = ReactFlow.applyNodeChanges(changes, nodes);
      return { nodesById: toNodeMap(nextNodes) };
    }),
    onEdgesChange: (changes) => set((state) => ({
      edges: ReactFlow.applyEdgeChanges(changes, state.edges)
    }))
  };
});
var nodeTypes = {
...
var LMCanvasInner = ({ focusNodeId, fitView }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ReactFlow__default.default,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(ReactFlow.Background, { variant: ReactFlow.BackgroundVariant.Dots, gap: 24, size: 1 })
    }
  );
};
var LMCanvas = ({ className, store, focusNodeId, fitView = true }) => {
  const defaultStore = react.useMemo(() => createCanvasStore(), []);
  const activeStore = store != null ? store : defaultStore;
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className, style: { width: "100%", height: "100%" }, children: /* @__PURE__ */ jsxRuntime.jsx(CanvasStoreProvider, { value: activeStore, children: /* @__PURE__ */ jsxRuntime.jsx(LMCanvasInner, { focusNodeId: focusNodeId != null ? focusNodeId : null, fitView }) }) });
};
...
exports.LMCanvas = LMCanvas_default;
exports.buildLinearGraphFromMessages = buildLinearGraphFromMessages;
...
exports.getMessageImages = getMessageImages;
exports.getMessageText = getMessageText;
exports.getMessageToolCalls = getMessageToolCalls;
exports.runMessageInteraction = runMessageInteraction;
exports.useCanvasStore = useCanvasStore;
exports.useCanvasStoreApi = useCanvasStoreApi;
